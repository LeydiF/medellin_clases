class Route < ActiveRecord::Base
  ...
  belongs_to :city_d, class_name: 'City', foreign_key: 'city_d_id'
  ...
  validate :city_o_city_d
   ...
   def city_o_city_d
  	errors.add(:city_d_id, "La ciudad destino debe ser diferente a la ciudad origen.") if self.city_d_id == self.city_o_id
   end
